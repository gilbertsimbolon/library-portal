<x-app-layout>
    ...
    <div class="flex flex-col justify-center items-center h-[calc(100vh-64px)] text-center text-white px-6">
        <div class="w-5/6 mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded-lg">
                ...
                <!-- Deskripsi -->
                <p class="mt-4 w-full text-lg text-justify indent-14 text-gray-500">
