<x-app-layout>
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                <label for="nama_lengkap"
                                    class="block text-sm/6 font-semibold text-gray-900 text-left ml-1">Nama
                                    Lengkap</label>
                                <div class="">
                                    <input type="text" name="nama" id="nama" autocomplete="given-name"
                                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 placeholder-italic focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
                                        placeholder="Nama Lengkap">
                                </div>
                            </div>
                            <div class="sm:col-span-2">
                                <label for="nim"
                                    class="block text-sm/6 font-semibold text-gray-900 text-left ml-1">NIM</label>
                                <div class="">
                            ...
                            <div class="sm:col-span-2">
                                <label for="email"
                                    class="block text-sm/6 font-semibold text-gray-900 text-left ml-1">Email
                                    Edukasi</label>
                                <div class="">
                            ...
                            <div class="sm:col-span-2">
                                <label for="no_hp"
                                    class="block text-sm/6 font-semibold text-gray-900 text-left ml-1">No.
                                    Handphone</label>
                                <div class="">
                            ...
                            <div class="sm:col-span-2">
                                <label for="fakultas"
                                    class="block text-sm/6 font-semibold text-gray-900 text-left ml-1">Fakultas</label>
                                <div class="">
                            ...
                            <div class="sm:col-span-2">
                                <label for="program_studi"
                                    class="block text-sm/6 font-semibold text-gray-900 text-left ml-1">Program
                                    Studi</label>
                                <div class="">
    ...
    <div id="successModal"
        ...
        <div class="modal-content bg-white p-6 rounded-lg">
            ...
            <button id="closeModal" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded-md">Tutup</button>
        </div>
    </div>
    <script>
